...
$aus['formstart'] .= '<input type="Button" id="command8" onclick="show_pardivs(\'transfer3\');" value="'.($lang['L_SFTP'] ?? '').'" class="ConfigButton"><br>'.$nl;
...
if (isset($databases['Name'][0]) && $databases['Name'][0] > '') {
    ...
    if (1 == (is_countable($databases['Name']) ? count($databases['Name']) : 0)) {
        ...
        $aus['db'] .= '<tr><td>'.Help($lang['L_HELP_DB'], 'conf1').$lang['L_LIST_DB'].'</td><td><input type="checkbox" class="checkbox-style" name="MultiDBDump" value="1" '.((isset($config['multi_dump']) && (1 == $config['multi_dump'])) ? 'CHECKED' : '').'>&nbsp;'.$lang['L_ACTIVATE_MULTIDUMP'].'</td>';
        ...
        $aus['db'] .= '<td align="center"><input type="checkbox" class="checkbox-style" name="db_multidump_'.$databases['db_selected_index'].'" value="db_multidump_'.$databases['db_selected_index'].'" '.((in_array($databases['db_actual'], $databases['multi'])) ? 'CHECKED' : '');
        $aus['db'] .= $disabled.'></td>';
        ...
        for ($i = 0; $i < (is_countable($databases['Name']) ? count($databases['Name']) : 0); ++$i) {
            if ($i != $databases['db_selected_index']) {
                ...
                $aus['db'] .= '<tr class="'.(($row % 2) ? 'dbrow' : 'dbrow1').'"><td>'.$databases['Name'][$i].'</td>';
                $aus['db'] .= '<td align="center"><input type="checkbox" class="checkbox-style" name="db_multidump_'.$i.'" value="db_multidump_'.$i.'" '.((in_array($databases['Name'][$i], $databases['multi'])) ? 'CHECKED' : '');
                $aus['db'] .= $disabled.'></td>';
...
$aus['global1'] .= '<td><input type="checkbox" class="checkbox-style" value="1" name="logcompression" '.(($config['zlib']) ? '' : 'disabled').((isset($config['logcompression']) && (1 == $config['logcompression'])) ? ' checked' : '').'>&nbsp;'.$lang['L_COMPRESSED'].'<br>';
...
$aus['global1'] .= '<td><input type="checkbox" class="checkbox-style" value="1" name="update_core" '.((isset($config['update_core']) && (1 == $config['update_core'])) ? ' checked' : '').'>';
$aus['global1'] .= '</td></tr>';
...
$aus['global1'] .= '<td><input type="checkbox" class="checkbox-style" value="1" name="compression" '.((isset($config['zlib']) && (1 == $config['zlib'])) ? '' : 'disabled').((isset($config['compression']) && (1 == $config['compression'])) ? ' checked' : '').'>';
$aus['global1'] .= '</td></tr>';
//Multipart-Backup -->

$aus['global1'] .= '<tr><td>'.Help($lang['L_HELP_MULTIPART'], '').$lang['L_MULTI_PART'].':&nbsp;</td>';
$aus['global1'] .= '<td><input type="checkbox" class="checkbox-style" value="1" name="multi_part" onclick="obj_disable(\'multipartgroesse1\', this.checked);obj_disable(\'multipartgroesse2\', this.checked);" '.((isset($config['multi_part']) && (1 == $config['multi_part'])) ? ' checked' : '').'>';
$aus['global1'] .= '</td></tr>';
...
$aus['global1'] .= '<td><input type="checkbox" class="checkbox-style" value="1" name="optimize_tables" '.((isset($config['optimize_tables_beforedump']) && (1 == $config['optimize_tables_beforedump'])) ? ' checked' : '').'>';
$aus['global1'] .= '</td></tr>';

$aus['global1'] .= '<tr><td>'.Help($lang['L_HELP_BINARY'], '').$lang['L_BINARY'].':</td>';
$aus['global1'] .= '<td><input type="checkbox" class="checkbox-style" value="1" name="binary_container" '.((isset($config['use_binary_container']) && (1 == $config['use_binary_container'])) ? ' checked' : '').'>';
$aus['global1'] .= '</td></tr>';
...
$aus['global1'] .= '<td><input type="checkbox" class="checkbox-style" value="1" name="empty_db_before_restore" '.((isset($config['empty_db_before_restore']) && (1 == $config['empty_db_before_restore'])) ? ' checked' : '').'>';
$aus['global1'] .= '</td></tr>';

$aus['global1'] .= '<tr><td>'.Help('', '').$lang['L_ERRORHANDLING_RESTORE'].':</td>';
$aus['global1'] .= '<td><input type="radio" class="radio-custom" name="stop_with_error" value="0" '.((isset($config['stop_with_error']) && (0 == $config['stop_with_error'])) ? ' checked' : '').'>&nbsp;'.$lang['L_EHRESTORE_CONTINUE'];
$aus['global1'] .= '&nbsp;&nbsp;&nbsp;<input type="radio" class="radio-custom" name="stop_with_error" value="1" '.((isset($config['stop_with_error']) && (1 == $config['stop_with_error'])) ? ' checked' : '').'>&nbsp;'.$lang['L_EHRESTORE_STOP'];
$aus['global1'] .= '</td></tr>';
...
$aus['global1'] .= '<td><input type="checkbox" class="checkbox-style" name="ignore_enable_keys" value="1" '.((isset($config['ignore_enable_keys']) && (1 == $config['ignore_enable_keys'])) ? ' checked' : '').'>';
$aus['global1'] .= '</td></tr>';
...
$aus['global3'] .= '<td><input type="checkbox" class="checkbox-style" value="1" name="server_caption" '.((isset($config['interface_server_caption']) && (1 == $config['interface_server_caption'])) ? ' checked' : '').'><br>';
$aus['global3'] .= '<input type="radio" class="radio-custom" name="server_caption_position" value="1" '.((isset($config['interface_server_caption_position']) && (1 == $config['interface_server_caption_position'])) ? 'checked' : '').'>&nbsp;'.$lang['L_IN_MAINFRAME'].'&nbsp;&nbsp;<input type="radio" class="radio-custom" name="server_caption_position" value="0" '.((isset($config['interface_server_caption_position']) && (0 == $config['interface_server_caption_position'])) ? 'checked' : '').'>&nbsp;'.$lang['L_IN_LEFTFRAME'].'';
$aus['global3'] .= '</td></tr>';
...
$aus['global3'] .= '<td><input type="radio" class="radio-custom" name="interface_table_compact" value="0" '.((isset($config['interface_table_compact']) && (0 == $config['interface_table_compact'])) ? 'checked' : '').'>&nbsp;normal&nbsp;&nbsp;&nbsp;';
$aus['global3'] .= '<input type="radio" class="radio-custom" name="interface_table_compact" value="1" '.((isset($config['interface_table_compact']) && (1 == $config['interface_table_compact'])) ? 'checked' : '').'>&nbsp;compact</td></tr>';
...
$aus['global2'] .= '<td><input type="checkbox" class="checkbox-style" value="1" name="auto_delete" '.((isset($config['auto_delete']) && (1 == $config['auto_delete'])) ? ' checked' : '').'>';
$aus['global2'] .= '</td></tr>';
...
$aus['transfer1'] .= '<td><input type="checkbox" class="checkbox-style" value="1" name="send_mail" '.((isset($config['send_mail']) && (1 == $config['send_mail'])) ? ' checked' : '').'>';
$aus['global3'] .= '</td></tr>';
...
$aus['transfer1'] .= '<input type="checkbox" class="checkbox-style" value="1" name="send_mail_dump" '.((isset($config['send_mail_dump']) && (1 == $config['send_mail_dump'])) ? ' checked' : '').'>';
$aus['global3'] .= '</td></tr>';
...
$aus['transfer1'] .= '<td><table><tr><td><input type="radio" class="radio-custom" name="cron_use_mail" value="1" '.((isset($config['cron_use_mail']) && (1 == $config['cron_use_mail'])) ? ' checked' : '').'>&nbsp;sendmail</td><td><input type="text" class="text" size="30" name="cron_sendmail" value="'.($config['cron_sendmail'] ?? '').'"></td><td></td></tr>';
$aus['transfer1'] .= '<tr><td><input type="radio" class="radio-custom" name="cron_use_mail" value="0" '.((isset($config['cron_use_mail']) && (0 == $config['cron_use_mail'])) ? ' checked' : '').'>&nbsp;SMTP</td><td><input type="text" class="text" size="30" name="cron_smtp" value="'.($config['cron_smtp'] ?? '').'"></td><td></td></tr><tr><td>&nbsp;</td><td>SMTP-Port: <strong>'.$config['cron_smtp_port'].'</strong></td><td></td></tr>';

$aus['transfer1'] .= '<tr><td><input type="radio" class="radio-custom" name="cron_use_mail" value="2" '.((isset($config['cron_use_mail']) && (2 == $config['cron_use_mail'])) ? ' checked' : '').'>&nbsp;Other SMTP</td>
...
<td>Art der Verschlüsselung</td><td>
	<input type="radio" class="radio-custom" name="other_smtp_encryption" value="0" '.((isset($config['other_smtp_encryption']) && (0 == $config['other_smtp_encryption'])) ? ' checked' : '').'>&nbsp;Keine&nbsp;
	<input type="radio" class="radio-custom" name="other_smtp_encryption" value="1" '.((isset($config['other_smtp_encryption']) && (1 == $config['other_smtp_encryption'])) ? ' checked' : '').'>&nbsp;SSL&nbsp;
	<input type="radio" class="radio-custom" name="other_smtp_encryption" value="2" '.((isset($config['other_smtp_encryption']) && (2 == $config['other_smtp_encryption'])) ? ' checked' : '').'>&nbsp;TLS&nbsp;
</td></tr>
...
<td>SMTP-Authentifizierung</td><td>
		<input type="checkbox" class="checkbox-style" value="1" name="other_smtp_auth" '.((isset($config['other_smtp_auth']) && (1 == $config['other_smtp_auth'])) ? ' checked' : '').'>
</td></tr>
...
$aus['global3'] .= '</td></tr>';
$aus['transfer1'] .= '<tr><td><input type="radio" class="radio-custom" name="cron_use_mail" value="3" '.((isset($config['cron_use_mail']) && (3 == $config['cron_use_mail'])) ? ' checked' : '').'>&nbsp;PHP Default</td><td>(none)</td><td></td></tr>';
...
for ($i = 0; $i < 3; ++$i) {
    ...
    $aus['transfer2'] .= '<td><input type="checkbox" class="checkbox-style" value="1" name="ftp_transfer['.$i.']" '.((!extension_loaded('ftp')) ? 'disabled ' : '').((isset($config['ftp_transfer'][$i]) && (1 == $config['ftp_transfer'][$i])) ? ' checked' : '').'></td></tr>';
    ...
    $aus['transfer2'] .= '<td><input type="checkbox" class="checkbox-style" name="ftp_mode['.$i.']" value="1" '.((isset($config['ftp_mode'][$i]) && (1 == $config['ftp_mode'][$i])) ? 'checked' : '').'>&nbsp;';
    $aus['transfer2'] .= $lang['L_FTP_PASSIVE'].'</td></tr><tr><td colspan="2">';

    $aus['transfer2'] .= '<tr><td>'.Help($lang['L_HELP_FTPSSL'], '').$lang['L_FTP_SSL'].':&nbsp;</td>';
    $aus['transfer2'] .= '<td><input type="checkbox" class="checkbox-style" name="ftp_useSSL['.$i.']" value="1" '.((isset($config['ftp_useSSL'][$i]) && (1 == $config['ftp_useSSL'][$i])) ? 'checked' : '').' '.((!extension_loaded('openssl')) ? 'disabled ' : '').'>';
...
for ($i = 0; $i < 3; ++$i) {
    ...
    $aus['transfer3'] .= '<td><input type="checkbox" class="checkbox-style" value="1" name="sftp_transfer['.$i.']" '.((!extension_loaded('ftp')) ? 'disabled ' : '').((isset($config['sftp_transfer'][$i]) && (1 == $config['sftp_transfer'][$i])) ? ' checked' : '').'></td></tr>';
...
$aus['cron'] .= '<td><input type="radio" class="radio-custom" value="0" name="cron_extender" '.((isset($config['cron_extender']) && (0 == $config['cron_extender'])) ? ' checked' : '').'>&nbsp;.pl';
$aus['cron'] .= '&nbsp;&nbsp;&nbsp;<input type="radio" class="radio-custom" value="1" name="cron_extender" '.((isset($config['cron_extender']) && (1 == $config['cron_extender'])) ? ' checked' : '').'>&nbsp;.cgi';
...
$aus['cron'] .= '<td><input type="checkbox" class="checkbox-style" value="1" name="cron_printout" '.((isset($config['cron_printout']) && (1 == $config['cron_printout'])) ? ' checked' : '').'>';

$aus['cron'] .= '<tr><td>'.Help($lang['L_HELP_CRONCOMPLETELOG'], '').$lang['L_CRON_COMPLETELOG'].':&nbsp;</td>';
$aus['cron'] .= '<td><input type="checkbox" class="checkbox-style" value="1" name="cron_completelog" '.((isset($config['cron_completelog']) && (1 == $config['cron_completelog'])) ? ' checked' : '').'>';
