...
if (1 == $import) {
    ...
    $impaus .= '<td><input type="radio" class="radio-custom" name="import_source" value="0" '.((0 == $sql['import']['import_source']) ? 'checked' : '').' onclick="check_csvdivs(1); return true">'.$lang['L_FROMTEXTBOX'].'<br>'.$nl;
    $impaus .= '<input type="radio" class="radio-custom" id="radio_csv0" name="import_source" value="1" '.((1 == $sql['import']['import_source']) ? 'checked' : '').' onclick="check_csvdivs(1); return true">'.$lang['L_FROMFILE'].'</td></tr>'.$nl;
    $impaus .= '<tr><td colspan="2"><input type="checkbox" class="checkbox-style" name="import_emptydb" value="1" '.((1 == $sql['import']['emptydb']) ? 'checked' : '').'>'.$lang['L_EMPTYTABLEBEFORE'].'</td></tr>'.$nl;
    $impaus .= '<tr><td colspan="2"><input type="checkbox" class="checkbox-style" name="import_createindex" value="1" '.((1 == $sql['import']['createindex']) ? 'checked' : '').'>'.$lang['L_CREATEAUTOINDEX'].'</td></tr>'.$nl;
    $impaus .= '</table>'.$nl;

    $impaus .= '</td><td valign="top">'.$nl;

    $impaus .= '<table cellpadding="0" cellspacing="0">'.$nl;
    $impaus .= '<tr><td colspan="2"><input type="checkbox" class="checkbox-style" name="f_import_namefirstline0" value="1" '.((1 == $sql['import']['namefirstline']) ? 'checked' : '').'>'.$lang['L_CSV_NAMEFIRSTLINE'].'</td></tr>'.$nl;
    ...
    $exaus .= '</td><td>'.$nl;
    $exaus .= ''.$nl;
    $exaus .= '<input type="radio" class="radio-custom" name="f_export_format" id="radio_csv0" value="0" '.((0 == $sql['export']['format']) ? 'checked' : '').' onclick="check_csvdivs(0); return true">'.'CSV'.'&nbsp;&nbsp;&nbsp;'.$nl;
    $exaus .= '<input type="radio" class="radio-custom" name="f_export_format" id="radio_csv1" value="1" '.((1 == $sql['export']['format']) ? 'checked' : '').' onclick="check_csvdivs(0); return true">'.'Excel'.'&nbsp;&nbsp;&nbsp;'.$nl;
    $exaus .= '<input type="radio" class="radio-custom" name="f_export_format" id="radio_csv2" value="3" '.((3 == $sql['export']['format']) ? 'checked' : '').' onclick="check_csvdivs(0); return true">'.$lang['L_EXCEL2003'].'<br>'.$nl;
    $exaus .= '<input type="radio" class="radio-custom" name="f_export_format" id="radio_csv4" value="4" '.((4 == $sql['export']['format']) ? 'checked' : '').' onclick="check_csvdivs(0); return true">'.'XML'.'&nbsp;&nbsp;&nbsp;'.$nl;
    $exaus .= '<input type="radio" class="radio-custom" name="f_export_format" id="radio_csv5" value="5" '.((5 == $sql['export']['format']) ? 'checked' : '').' onclick="check_csvdivs(0); return true">'.'HTML'.'<br><br>'.$nl;
    $exaus .= '<div id="csv0"><fieldset><legend>CSV-Optionen</legend><table cellpadding="0" cellspacing="0"><tr><td colspan="2">'.$nl;
    $exaus .= '<input type="checkbox" class="checkbox-style" name="f_export_namefirstline0" value="1" '.((1 == $sql['export']['namefirstline']) ? 'checked' : '').'>'.$lang['L_CSV_NAMEFIRSTLINE'].'</td></tr>'.$nl;
    ...
    $exaus .= '<input type="checkbox" class="checkbox-style" name="f_export_namefirstline1" value="1"'.((1 == $sql['export']['namefirstline']) ? 'checked' : '').'>'.$lang['L_CSV_NAMEFIRSTLINE'].'</td></tr>'.$nl;
    ...
    $exaus .= '<tr><td><input type="checkbox" name="f_export_xmlstructure" value="1" class="checkbox-style" '.((1 == $sql['export']['xmlstructure']) ? 'checked' : '').'> mit Struktur</td></tr>';
    $exaus .= '</table></fieldset></div>'.$nl;

    $exaus .= '<div id="csv5"><fieldset><legend>HTML-Optionen</legend><table>';
    $exaus .= '<tr><td><input type="checkbox" name="f_export_htmlstructure" value="1" class="checkbox-style" '.((1 == $sql['export']['htmlstructure']) ? 'checked' : '').'> mit Struktur</td></tr>';
    $exaus .= '</table></fieldset></div>'.$nl;

    $exaus .= '</td><td>'.$nl;
    $exaus .= '<input type="radio" class="radio-custom" name="f_export_sendresult" value="0" '.((0 == $sql['export']['sendfile']) ? 'checked' : '').' onclick="check_csvdivs(0); return true">'.$lang['L_SHOWRESULT'].'<br>'.$nl;
    $exaus .= '<input type="radio" class="radio-custom" name="f_export_sendresult" id="radio_csv3" value="1" '.((1 == $sql['export']['sendfile']) ? 'checked' : '').' onclick="check_csvdivs(0); return true">'.$lang['L_SENDRESULTASFILE'].'<br>'.$nl;
    $exaus .= '<div id="csv3"><input type="checkbox" class="checkbox-style" name="f_export_compressed" value="1" '.((1 == $sql['export']['compressed']) ? 'checked' : '').'>'.$lang['L_COMPRESSED'].'</div><br>'.$nl;
